...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 05 juil. 2020 à 12:18
...
(9, 'meriem@gmail.com', 'IiwFEXti3H+3lwsYb94SJtCMG1Q=', 'Laayouni', 'Meriem', '0612346578', '2020-06-12', 'test', 1, 'a:1:{i:0;s:10:\"ROLE_ADMIN\";}', '2020-06-26', 'Administrateur', NULL, NULL, NULL, '2020-07-05 12:14:24', 1),
...
(31, 'inscri@gmail.com', 'nrFKSrK4nrtxRzSErRgg7cMN0p4=', NULL, NULL, NULL, NULL, NULL, 1, 'a:1:{i:0;s:9:\"ROLE_USER\";}', '2020-07-03', 'Editeur', NULL, NULL, NULL, '2020-07-03 17:21:43', 1),
...
(61, 1, 'Bradia'),
(62, 1, 'Brikcha'),
(63, 1, 'Casablanca ( Dar al-Beïda)'),
(64, 1, 'Chefchaouen'),
(65, 1, 'Chemaia'),
(66, 1, 'Chichaoua'),
(67, 1, 'Dakhla (Ad Dakhla, Villa Cisneros)'),
(68, 1, 'Dar Gueddari'),
(69, 1, 'Dar Kebdani'),
(70, 1, 'Demnate'),
(71, 1, 'Douar Bel Aguide (Bel air)'),
(72, 1, 'Driouch'),
(73, 1, 'El Aioun Sidi Mellouk'),
(74, 1, 'El Guerdane'),
(75, 1, 'El Hajeb'),
(76, 1, 'El Hanchane'),
(77, 1, 'El Jadida ( Mazagan)'),
(78, 1, 'Elkbab'),
(79, 1, 'El Menzel'),
(80, 1, 'El Ouatia'),
(81, 1, 'Erfoud (o Arfoud)'),
(82, 1, 'Errachidia (Ksar es-Souk)'),
(83, 1, 'Essaouira ( Mogador)'),
(84, 1, 'Farcia'),
(85, 1, 'Fès'),
(86, 1, 'Figuig'),
(87, 1, 'Fnideq'),
(88, 1, 'Fquih Ben Salah'),
(89, 1, 'Er-Rich'),
(90, 1, 'Guelmim'),
(91, 1, 'Goulmima'),
(92, 1, 'Guelta Zemmour'),
...
(103, 1, 'Imilili'),
(104, 1, 'Imintanoute'),
(105, 1, 'Imouzzer Kandar'),
(106, 1, 'Immouzer Marmoucha'),
(107, 1, 'Inezgane'),
(108, 1, 'jerada'),
(109, 1, 'Jorf'),
(110, 1, 'Jorf El Melha'),
...
(112, 1, 'Kassita'),
(113, 1, 'Kattara'),
(114, 1, 'Kénitra ( Port-Lyautey)'),
(115, 1, 'Kehf Nsour'),
(116, 1, 'Khémisset'),
(117, 1, 'Khemis Sahel'),
(118, 1, 'Khemis Zemamra (Doukkala)'),
(119, 1, 'Khenichet'),
(120, 1, 'Khénifra'),
(121, 1, 'Khouribga'),
(122, 1, 'Ksar el-Kébir'),
(123, 1, 'Laayoune (El Aaiún)'),
(124, 1, 'Lagouira ( Cabo Blanco)'),
(125, 1, 'Lalla Mimouna'),
(126, 1, 'Larache'),
(127, 1, 'Lixus'),
(128, 1, 'Lqliâa'),
(129, 1, 'Madagh'),
(130, 1, 'Riad Heritage ; Sonic'),
(131, 1, 'Marrakech'),
(132, 1, 'Martil'),
(133, 1, 'Mechra Bel Ksiri'),
(134, 1, 'Mediek ou M\'diq'),
(135, 1, 'Mediouna'),
(136, 1, 'Mehdia'),
(137, 1, 'Meknès'),
(138, 1, 'Melloussa'),
(139, 1, 'Midelt'),
(140, 1, 'Mirleft'),
(141, 1, 'Mohammédia ( Fédala)'),
(142, 1, 'Moqrisset'),
(143, 1, 'Moulay Ali Cherif'),
(144, 1, 'Moulay Bousselham'),
(145, 1, 'Moulay Idriss Zerhoun'),
(146, 1, 'M\'rirt'),
(147, 1, 'nador'),
(148, 1, 'nhima'),
(149, 1, 'Ouarzazate'),
...
(156, 1, 'Oulad Berhil'),
(157, 1, 'Oulad Frej'),
(158, 1, 'Oulad Ghadbane'),
(159, 1, 'Oulad H Riz Sahel'),
(160, 1, 'Oulad M\'Rah'),
(161, 1, 'Oulad M Barek'),
(162, 1, 'Oulad Teïma'),
(163, 1, 'Oulad Zbair'),
...
(166, 1, 'Oulmès'),
(167, 1, 'Ounagha'),
(168, 1, 'Rabat (Ribat al-Fath)Ras El Ain'),
(169, 1, 'Ras El Ma'),
(170, 1, 'Ribate El Kheir'),
(171, 1, 'Rissani ( Sijilmassa)'),
(172, 1, 'Sabaa Aiyoun'),
(173, 1, 'Safi'),
(174, 1, 'Saidia'),
(175, 1, 'Salé'),
(176, 1, 'Sebt El Maârif'),
(177, 1, 'Sebt Gzoula'),
(178, 1, 'Sebt Jahjouh'),
(179, 1, 'Sefrou'),
(180, 1, 'Settat ( Chaouia )'),
(181, 1, 'Sid Zouin'),
(182, 1, 'Sidi Abdallah Ghiat'),
(183, 1, 'Sidi Addi'),
(184, 1, 'Sidi Ali Ban Hamdouche'),
(185, 1, 'Sidi Allal El Bahraoui'),
(186, 1, 'Sidi Allal Tazi'),
(187, 1, 'Sidi Bou Othmane'),
(188, 1, 'Sidi Boubker'),
(189, 1, 'Sidi Jaber'),
(190, 1, 'Sidi Kacem ( Chérarda )'),
(191, 1, 'Sidi Lyamani'),
(192, 1, 'Sidi Rahhal'),
(193, 1, 'Sidi Slimane'),
(194, 1, 'Sidi Smaïl'),
(195, 1, 'Sidi Taibi'),
(196, 1, 'Sidi Yahya el Gharb'),
(197, 1, 'Skhirat'),
(198, 1, 'Smara (Semara)'),
(199, 1, 'Souq Larb\'a al Gharb'),
(200, 1, 'Taddert'),
(201, 1, 'Tafetachte'),
(202, 1, 'Tafrisset'),
(203, 1, 'Taghjijt'),
...
(208, 1, 'Talmest'),
(209, 1, 'Talssint'),
(210, 1, 'Tanger ( Tangerois )'),
(211, 1, 'Tan-Tan'),
(212, 1, 'Tamallalt'),
(213, 1, 'Tamanar'),
(214, 1, 'Tameslouht'),
(215, 1, 'Taourirte'),
(216, 1, 'Tarfaya (Cabo Juby)'),
(217, 1, 'Taroudannt'),
(218, 1, 'Tata'),
(219, 1, 'Taza'),
(220, 1, 'Taznakht'),
...
(233, 1, 'Tiznit'),
(234, 1, 'Tiztoutine'),
(235, 1, 'Torres de Alcala'),
(236, 1, 'Tifelt'),
(237, 1, 'Volubilis ( Oualili)'),
(238, 1, 'Youssoufia'),
(239, 1, 'Zagora'),
(240, 1, 'Zaio');
